...
memory_consumption = gpu_memory_usage(0)
with open(os.path.join(output_dir,"time_memory_consumption.txt"),'w') as f:
    f.write("Time_consumption=%s\tMemory_consumption=%s" % (time_consumption ,memory_consumption))
